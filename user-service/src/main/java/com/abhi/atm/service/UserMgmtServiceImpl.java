...
import com.abhi.atm.dao.ConfigParamRepository;
import com.abhi.atm.dao.ConfigParamValue;
import com.abhi.atm.dao.User;
import com.abhi.atm.dao.UserRepository;
		...
		try {
			...
			if (!roleMatch) {
				...
				throw new BusinessServiceException(
						"Incorrect role, please select role from { " + availableRolesStr + "}");
			}
